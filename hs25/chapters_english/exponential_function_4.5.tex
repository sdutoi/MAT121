...
\paragraph*{Theorem 4.5.9} For $\alpha \in \mathbb{R}_{>0}$ holds:
\begin{align*}
    \lim_{x \to \infty} x^{-\alpha} \ln(x) &= 0 \\
    \lim_{x \to +0} x^{\alpha} \ln(x) &= 0.
\end{align*}

\textbf{Proof.} From $x \to +\infty$ follows $y := \ln x \xrightarrow{x \to \infty} \infty$. Then
\[
\lim_{x \to +\infty} x^{-\alpha} \ln(x) 
\stackrel{x=e^y}{=} \frac{1}{\alpha} \lim_{y \to \infty} \frac{\alpha y}{e^{\alpha y}} 
\stackrel{z=\alpha y > 0}{=} \frac{1}{\alpha} \lim_{z \to \infty} \frac{z}{e^z} 
\stackrel{\text{Thm 4.5.4(3)}}{=} 0.
\]

Similarly follows:
\[
\lim_{x \to +0} x^{\alpha} \ln(x) 
\stackrel{x=\frac{1}{y}}{=} \lim_{y \to +\infty} y^{-\alpha} \ln \frac{1}{y} 
